...
optional arguments:
  ...
  --density                        The density (in kg/m^3) to assign to the converted asset. (default: 200.0)
...
parser.add_argument(
    ...
    type=float,
    default=200.0,
    help="The density (in kg/m^3) to assign to the converted asset. If not provided, then no density is added.",
)
...
def main():
    ...
    # Mass properties
    mass_props = schemas_cfg.MassPropertiesCfg(density=args_cli.density)
